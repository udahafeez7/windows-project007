                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xl me-3">
                                                <img src="{{ !empty($profileData->photo) ? asset('upload/admin_images/' . $profileData->photo) : asset('upload/no_image.jpg') }}"
                                                    alt="{{ !empty($profileData->photo) ? 'User Profile Photo' : 'Default No Image' }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-3 mt-lg-0">
                                                ...
                                                <div class="mb-3">
                                                    <label for="example-text-input" class="form-label">Latest Image</label>
                                                ...
                                                <div class="mb-3">
                                                    <img id="showImage"
                                                        src="{{ !empty($profileData->photo) ? 'upload/admin_images/' . $profileData->photo : url('upload/no_image.jpg') }}"
                                                        alt=""
                                                        class="img-fluid rounded-block d-block p-1 bg-primary"
                                                        width="110">
