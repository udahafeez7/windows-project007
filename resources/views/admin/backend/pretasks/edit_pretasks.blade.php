            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Edit Exsisting Pretasks</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Edit Pretasks</li>
                            </ol>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('pretasks.update') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $pretasks->id }}">

                                <div class="row">
                                    <div class="col-lg-12">
                                        <div>
                                            <div class="form-group mb-3">
                                                <label for="example-text-input" class="form-label"> Prestasks Name</label>
                                                <input class="form-control" name="pretasks_name" type="text"
                                                    value="{{ $pretasks->pretasks_name }}" id="example-text-input">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-3 mt-lg-0">
                                            ...
                                            <div class="mb-3">
                                                <img id="showImage" src="{{ asset($pretasks->image) }}" alt=""
