                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div>
                                                    ...
                                                    <!-- Ensuring proper margin between the Confirm Password field and the Save Changes button -->
                                                    <div class="mt-4">
                                                        <button type="submit"
                                                            class="btn btn-primary waves-effect waves-light transition duration-200 ease-in-out transform hover:scale-105 hover:bg-blue-600">
                                                            Save Changes
                                                        </button>
                                                    </div>
                                                </div>
