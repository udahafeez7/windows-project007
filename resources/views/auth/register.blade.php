...
<head>
    ...
    <title>Welcome New Users, Please Register First</title>
    <!-- Favicon Icon -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                                <h3 class="login-heading mb-4">Welcome New Users!</h3>
                                @if ($errors->any())
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <button type="submit"
                                        class="btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2">Register</button>
